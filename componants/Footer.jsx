        ...
        <div className="main-btn">
          <button className="contact">
            <a href="https://www.facebook.com/yok.yok.9/" target="_blank">
              <img src="../src/img/facebook.png" alt="fb-icon" />
            </a>
          </button>
          <button className="contact">
            <a href="https://www.instagram.com/patiparn.wong/" target="_blank">
              <img src="../src/img/instagram.png" alt="ig-icon" />
            </a>
          </button>
          <button className="contact">
            <a href="https://github.com/Yok-Patiparn" target="_blank">
              <img src="../src/img/github.png" alt="github-icon" />
            </a>
          </button>
          <button className="contact">
            <a
              ...
              target="_blank"
            >
              <img src="../src/img/linkedin.png" alt="linkedin-icon" />
            </a>
          </button>
        </div>
      </div>
